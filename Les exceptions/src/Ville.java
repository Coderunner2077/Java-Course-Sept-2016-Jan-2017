...
public class Ville {
	 ...
	 * @param pNom
	 */
	public void setNomVille(String pNom) throws NomVilleException
	{
		if(pNom.length() < 3)
			throw new NomVilleException("Le nom de la ville doit comporter au moins 3 caractères ! Nom : " + pNom);
		else			
			nomVille = pNom;
	}
	/**
	 ...
	 * @param pNbre
	 */
	public void setNbreHabitants(int pNbre) throws NombreHabitantsException
	{
		if(pNbre < 0)
			throw new NombreHabitantsException(pNbre);
